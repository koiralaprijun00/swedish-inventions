    ...
    <div className="swiss-filter-panel">
      <div className="swiss-filter">
        {categories.map((cat, index) => (
          ...
          >
            <span className="swiss-filter__number">
...
function HomeContent() {
  ...
  const baseUrl =
    locale === "en"
      ? "https://swedishinventions.com"
      : `https://swedishinventions.com/${locale}`;
  ...
  const categories = [
    ...
    {
      key: "engineeringTechnology",
      label: t("categories.engineeringTechnology"),
    },
    { key: "digitalTechnology", label: t("categories.digitalTechnology") },
    {
      key: "artificialIntelligence",
      label: t("categories.artificialIntelligence"),
    },
  ...
  return (
    <>
      ...
      <main className="swiss-main">
        <section
          id="catalogue"
          className="swiss-section swiss-section--catalogue container"
        >
              ...
              <div key={category.category} className="swiss-category-block">
                <div className="swiss-grid swiss-category-block__header">
                  <div className="col-span-12 md:col-span-3">
                    <span className="swiss-category-block__index">
                      {String(categoryIdx + 1).padStart(2, "0")}
                    </span>
                    <span className="swiss-category-block__name">
