    ...
    items: [
      {
        ...
        oneLineHeading: {
          en: "Creamy Revolution: Oat Milk Takes the World by Storm",
          sv: "Krämig Revolution: Havremjölk Tar Världen med Storm"
        },
        description: {
      ...
      },
      {
        ...
        oneLineHeading: {
          en: "The Coca-Cola bottle is one of the most recognizable designs in the world. With its unique curves and instantly recognizable shape, it has become a symbol of branding excellence. But what many people don’t realize is that the design of the Coca-Cola bottle has strong Swedish roots. The bottle that changed beverage packaging forever was designed by Swedish-born innovator Alexander Samuelson.",
          sv: "Coca-Cola-flaskan är en av världens mest igenkännliga designer. Med sina unika kurvor och omedelbart identifierbara form har den blivit en symbol för varumärkesexcellens. Men vad många inte vet är att designen av Coca-Cola-flaskan har starka svenska rötter. Flaskan som för alltid förändrade dryckesförpackningar skapades av den svenskfödde innovatören Alexander Samuelson."
        },
        description: {
    ...
    items: [
      {
        ...
        oneLineHeading: {
          en: "The Swedish Marvel: How the Adjustable Wrench Revolutionized Tools",
          sv: "Den svenska underverket: Hur den justerbara skiftnyckeln revolutionerade verktyg"
        },
        inventorName: "Johan Petter Johansson",
        description: {
          en: "When you think of groundbreaking inventions, your mind might wander to the automobile, the airplane, or even the smartphone. But one tool that has quietly shaped industries, households, and repair shops worldwide is the adjustable wrench—a simple yet ingenious device that was invented in Sweden.",
          sv: "När du tänker på banbrytande uppfinningar kanske du föreställer dig bilen, flygplanet eller till och med smarttelefonen. Men ett verktyg som tyst har format industrier, hushåll och verkstäder världen över är den justerbara skiftnyckeln – en enkel men genialisk uppfinning som kommer från Sverige."
        },
      ...
      },
      {
        ...
        oneLineHeading: {
          en: "Seeing Sound: Ultrasound’s Medical Miracle",
          sv: "Se med Ljud: Ultraljudets Medicinska Mirakel"
        },
        description: {
      ...
      },
      {
        ...
        oneLineHeading: {
          en: "Buckle Up: The Belt That Saved Millions",
          sv: "Spänn Fast: Bältet Som Räddade Miljoner"
        },
        description: {
          en: "Every time you buckle up in a car, you are using one of the greatest life-saving inventions in automotive history—the three-point seatbelt. This simple yet revolutionary device has saved millions of lives worldwide, and it was invented in Sweden by Volvo engineer Nils Bohlin in 1959.",
          sv: "Varje gång du spänner fast säkerhetsbältet i en bil använder du en av de mest livräddande uppfinningarna i bilhistorien – tre-punktsbältet. Denna enkla men revolutionerande uppfinning har räddat miljontals liv världen över och uppfanns i Sverige av Volvo-ingenjören Nils Bohlin 1959."
        },
    ...
    items: [
      {
        ...
        oneLineHeading: {
          en: "Wires Be Gone: Bluetooth Connects the World",
          sv: "Sladdar Bort: Bluetooth Kopplar Ihop Världen"
        },
        description: {
          en: "This game-changing technology was developed by Swedish engineer Jaap Haartsen while working for Ericsson in the 1990s. Today, Bluetooth is used by billions of devices worldwide, proving once again that Swedish innovation is at the forefront of global technology.",
          sv: "Denna banbrytande teknologi utvecklades av den svenske ingenjören Jaap Haartsen medan han arbetade för Ericsson på 1990-talet. Idag används Bluetooth av miljarder enheter världen över, vilket än en gång bevisar att svensk innovation ligger i framkant av global teknik."
        },
      ...
      },
      {
        ...
        oneLineHeading: {
          en: "Sea Tracker: AIS Guides Ships Safely",
          sv: "Havets Spårare: AIS Leder Fartyg Säkert"
        },
        description: {
          en: "The Automatic Identification System (AIS) is one of the most important technologies in modern maritime navigation, ensuring that ships worldwide can avoid collisions, track movements, and communicate more efficiently. Invented in Sweden, AIS has become a mandatory system for large vessels worldwide, allowing ships, ports, and coast guards to monitor vessel traffic in real-time. This groundbreaking innovation has significantly reduced accidents at sea, improved global shipping logistics, and strengthened maritime security.",
    ...
    items: [
      {
        ...
        oneLineHeading: {
          en: "Honor of Excellence: The Prize That Inspires Greatness",
          sv: "Ära av Excellence: Priset Som Inspirerar Storhet"
        },
        description: {
          en: "Few awards in history hold as much prestige as the Nobel Prize. Established by Swedish industrialist Alfred Nobel in 1895, the prize honors individuals and organizations that have made groundbreaking contributions to science, literature, and peace. Every year, the world watches as the Nobel Prizes are awarded in Stockholm and Oslo, recognizing achievements that have changed humanity for the better. Sweden’s commitment to intellectual progress, discovery, and global improvement has made the Nobel Prize one of the most respected honors in the world.",
          sv: "Få utmärkelser i historien har lika hög prestige som Nobelpriset. Instiftat av den svenske industrialisten Alfred Nobel 1895 hedrar priset individer och organisationer som gjort banbrytande bidrag till vetenskap, litteratur och fred. Varje år följer världen med när Nobelprisen delas ut i Stockholm och Oslo, och erkänner prestationer som förbättrat mänskligheten. Sveriges engagemang för intellektuell utveckling, upptäckter och global förbättring har gjort Nobelpriset till en av världens mest respekterade utmärkelser."
        },
