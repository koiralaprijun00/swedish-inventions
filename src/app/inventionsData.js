        ...
        items: [
            {
                ...
                inventorName: "Founders: Sigge Labor, Max Junestrand & August Erséus",
                year: 2023,
            ...
            {
                id: 202,
                name: { en: "Sana", sv: "Sana" },
                inventorName: "Founder: Joel Hellermark",
                year: 2016,
            ...
            {
                id: 203,
                name: { en: "Tandem Health", sv: "Tandem Health" },
                inventorName: "Founders: Oliver Åstrand, Oscar Boldt-Christmas & Lukas Saari",
                year: 2023,
            ...
            {
                id: 204,
                name: { en: "Listen Labs", sv: "Listen Labs" },
                inventorName: "Founders: Alfred Wahlforss & Florian Juengermann",
                year: 2023,
            ...
            {
                id: 205,
                name: { en: "Filed", sv: "Filed" },
                inventorName: "Founders: Johannes Schildt, Jakob Olsson & team",
                year: 2024,
            ...
            {
                id: 206,
                name: { en: "Lightbringer", sv: "Lightbringer" },
                inventorName: "Founders: Team Lightbringer",
                year: 2024,
            ...
            {
                id: 207,
                name: { en: "Talentium", sv: "Talentium" },
                inventorName: "Founders: Talentium Team",
                year: 2023,
            ...
            {
                id: 208,
                name: { en: "AI-Bob", sv: "AI-Bob" },
                inventorName: "Founder: Elin Mårtensson",
                year: 2022,
            ...
            {
                id: 209,
                name: { en: "Aris Machina", sv: "Aris Machina" },
                inventorName: "Founders: Peter Carlsson & Siddharth Khullar",
                year: 2023,
                oneLineHeading: { en: "Aris Machina optimises manufacturing with AI twins", sv: "Aris Machina optimerar tillverkning med AI-tvillingar" },
                description: {
                    en: "Aris Machina crafts intelligent tooling for factories so operators can model production scenarios and cut waste.",
                    sv: "Aris Machina utvecklar intelligenta verktyg för fabriker så att operatörer kan simulera produktion och minska slöseri.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.arismachina.com/",
            },
            {
                id: 210,
                name: { en: "Andon Labs", sv: "Andon Labs" },
                inventorName: "Founders: Andon Labs Team",
                year: 2023,
                oneLineHeading: { en: "Andon Labs secures frontier AI models for enterprises", sv: "Andon Labs säkrar frontier-modeller för företag" },
                description: {
                    en: "Andon Labs works with partners like Anthropic to harden and monitor large models so regulated industries can adopt AI safely.",
                    sv: "Andon Labs samarbetar med aktörer som Anthropic för att säkra och övervaka stora modeller så att reglerade branscher kan använda AI tryggt.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.andonlabs.com/",
            },
            {
                id: 211,
                name: { en: "Buddywise", sv: "Buddywise" },
                inventorName: "Founders: Buddywise Team",
                year: 2020,
                oneLineHeading: { en: "Buddywise spots workplace hazards with computer vision", sv: "Buddywise upptäcker arbetsplatsrisker med datorseende" },
                description: {
                    en: "Buddywise analyses camera feeds to detect unsafe behaviour and prevents accidents before they happen in industrial settings.",
                    sv: "Buddywise analyserar kameraflöden för att upptäcka osäkra beteenden och förebygger olyckor i industriella miljöer.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.buddywise.ai/",
            },
            {
                id: 212,
                name: { en: "Gilion", sv: "Gilion" },
                inventorName: "Founders: Gilion Team",
                year: 2020,
                oneLineHeading: { en: "Gilion combines revenue monitoring with flexible financing", sv: "Gilion kombinerar intäktsanalys med flexibel finansiering" },
                description: {
                    en: "Gilion, formerly Ark Capital, uses AI to monitor business performance in real time and extend non-dilutive loans to growing companies.",
                    sv: "Gilion, tidigare Ark Capital, använder AI för att följa företags utveckling i realtid och erbjuda lån utan utspädning till växande bolag.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.gilion.com/",
            },
            {
                id: 213,
                name: { en: "Kognic", sv: "Kognic" },
                inventorName: "Founders: Daniel Langkilde & Mikael Rousson",
                year: 2018,
                oneLineHeading: { en: "Kognic builds better datasets for machine learning", sv: "Kognic bygger bättre datamaterial för maskininlärning" },
                description: {
                    en: "Kognic helps automotive and industrial teams manage training data with quality controls, accelerating safe deployment of perception systems.",
                    sv: "Kognic hjälper fordons- och industriföretag att hantera träningsdata med kvalitetskontroller och påskyndar säker lansering av perceptionssystem.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.kognic.com/",
            },
            {
                id: 214,
                name: { en: "Rerun", sv: "Rerun" },
                inventorName: "Founders: Emil Ernerfeldt, David Sandberg & Adam Britton",
                year: 2021,
                oneLineHeading: { en: "Rerun visualises sensor data for robotics teams", sv: "Rerun visualiserar sensordata för robotikteam" },
                description: {
                    en: "Rerun lets robotics and drone developers inspect multimodal sensor streams in real time, improving how physical AI systems are debugged.",
                    sv: "Rerun gör det möjligt för robotik- och dronutvecklare att granska multimodala sensordata i realtid och förbättrar felsökning av fysiska AI-system.",
                },
                imageSrc: "/invention-images/ais.webp",
            ...
            {
                id: 215,
                name: { en: "Validio", sv: "Validio" },
                inventorName: "Founders: Theodor Sandström & Patrik Tran",
                year: 2019,
                oneLineHeading: { en: "Validio keeps data quality high for AI pipelines", sv: "Validio håller datakvalitet hög i AI-flöden" },
                description: {
                    en: "Validio monitors data freshness and accuracy across warehouses and streams so AI teams can trust the inputs that drive their models.",
                    sv: "Validio bevakar dators färskhet och noggrannhet i lager och strömmar så att AI-team kan lita på underlaget för sina modeller.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.validio.io/",
            },
            {
                id: 216,
                name: { en: "Vionlabs", sv: "Vionlabs" },
                inventorName: "Founders: Vionlabs Team",
                year: 2010,
                oneLineHeading: { en: "Vionlabs analyses video to power smart recommendations", sv: "Vionlabs analyserar video för smarta rekommendationer" },
                description: {
                    en: "Vionlabs reads the emotional DNA of video so streamers like Paramount can serve tailored recommendations and editing insights.",
                    sv: "Vionlabs tolkar filmernas känslomässiga DNA så att aktörer som Paramount kan leverera träffsäkra rekommendationer och redigeringsinsikter.",
                },
                imageSrc: "/invention-images/ais.webp",
                link: "https://www.vionlabs.com/",
            },
        ],
    },
    {
