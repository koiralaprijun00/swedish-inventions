      ...
      <main>
        ...
        <InventionCard
          ...
          <InventionCard
            ...
            imageSrc="https://via.placeholder.com/150"
          />
          <InventionCard name="Ericsson" description="A major telecommunications company, pioneering mobile communication." imageSrc="https://via.placeholder.com/150" />
          </div>  
        </Section>

        <Section title="Gaming">
        <div className="grid-container">
          <InventionCard name="Minecraft" description="A globally popular sandbox video game created by Mojang, a Swedish company." imageSrc="https://via.placeholder.com/150" />
          <InventionCard name="Candy Crush" description="A highly addictive mobile game developed by King, a Swedish company." imageSrc="https://via.placeholder.com/150" />
          </div>
        </Section>
        ...
        <div className="grid-container">
          <InventionCard
            ...
            imageSrc="https://via.placeholder.com/150"
          />
          <InventionCard name="First Cholera Vaccine" description="Developed by a Swedish scientist to combat the deadly disease." imageSrc="https://via.placeholder.com/150" />
          <InventionCard
        ...
        <div className="grid-container">
          <InventionCard name="H&M" description="A leading global fashion retailer, known for affordable clothing." imageSrc="https://via.placeholder.com/150" />
          <InventionCard
            name="IKEA"
...
function InventionCard({ name, description, imageSrc }) {
  return (
